...
<nav class="navbar navbar-expand-sm navbar-light bg-secondary" id="nav-app">
  <div class="container">
    <a class="navbar-brand pe-auto hover-shadow" href="./"><img style="height:50px;weight:50px;" src="../src/uploads/eshoppers-nav-logo-removebg-preview.png" class="img-fluid rounded-top" alt=""> Product List</a>
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavId">
      <ul class="navbar-nav me-auto mt-2 mt-lg-0">
        <li class="nav-item">
          <a class="nav-link active" href="order.php" @click="changeColor(0)" aria-current="page"><i class="fas fa-shopping-cart"></i> Orders <span class="visually-hidden">(current)</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="shipping.php" @click="changeColor(1)" aria-current="page"><i class="fas fa-shipping-fast"></i> Items Shipped <span class="visually-hidden">(current)</span></a>
        </li>
      </ul>
      <ol id="profileID" class="navbar-nav">
        <li class="nav-item dropdown pr-3">
          <a class="nav-link dropdown-toggle" @click="changeColor(2)" href="#" id="dropdownId" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded='false'>
  ...
  <div class="mb-3">
    <p class="text-center">Email: <?php echo($_SESSION['email']);?></p>
            ...
            <button type="button" class="dropdown-item mb-2" data-bs-toggle="modal" data-bs-target="#settingModal"><i class="fas fa-cog"></i> settings</button>
            <button type="button" class="btn btn-danger w-100" @click.prevent="logout"><i class="fas fa-sign-out-alt"></i> Log out</button>
          </div>
        </li>
      </ol>
    </div>
