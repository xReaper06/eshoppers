...
$app = "<script src='./js/orders.js'></script>";?>
<?php include"navigation.php";?>
<div class="" id="main-app">
  <div class="mt-5 m-3">
      <div class="card">
        <div class="card-body">
          <h4><i class="bi bi-cart3"></i> Orders</h4>
          <table id="myTable" class="table table-responsive w-100">
  <thead>
    <tr>
    <th>Order number</th>
            <th>User Profile</th>
  ...
  <tbody v-for="order in orderCheckouts" :key="order.checkout_id">
          <tr>
            ...
            <td>
              <button type="button" class="btn btn-primary" @click="cancelOrder(order)">Cancel</button>
              <button type="button" class="btn btn-primary" @click="removeOrder(order)">Remove</button>
            </td>
          </tr>
        </tbody>
</table>
