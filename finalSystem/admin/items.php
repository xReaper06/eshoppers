...
$app = "<script src='./js/items.js'></script>"?>
<?php include"./navigation.php"?>
<div id="items-app">
<div class="input-group mb-3">
  <span class="input-group-text"><i class="bi bi-search"></i></span>
  <input type="text" class="form-control" placeholder="Search Product" v-model="search" @keyup="getProducts">
</div>
<div class="card">
  <div class="card-body">
      ...
      <tbody v-for="product in products" :key="product.prod_id">
        <tr>
          ...
          <td>
            ...
            <button type="button" class="btn btn-danger" @click="deleteproducts(product)"><i class="bi bi-trash"></i></button>
          </td>
        </tr>
      </tbody>
    </table> 
